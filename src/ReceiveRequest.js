...
class ReceiveRequest extends Component {
  ...
  test() {
    console.log(
      this.state.dateDetails[Object.keys(this.state.dateDetails)[1]].location
    );
    ...
    return (
      <div id="datebackground">
        <div>
          ...
          <p>
            It's got inventive codadcktails and small plates in a warm,
            eco-friendly setting with regular tastings and classes. <br />
          </p>
