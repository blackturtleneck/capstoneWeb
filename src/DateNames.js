...
const popoverHoverFocus = (
  <Popover id="freBrew" title="Fremont Brewery">
    ...
    <b>$</b> <br />
    This kid and dog friendly beer hall with bench tables serves up seasonal
    ales and free pretzels.
  </Popover>
);
...
const popoverHoverFocus3 = (
  <Popover id="bakdoor" title="The Backdoor">
    ...
    <b>$ </b>
    <br />
    Speakeasy-style lounge behind Roxy's Diner, for cocktails, small plates and
...
const popoverHoverFocus4 = (
  <Popover id="barrel" title="The Barrel Thief">
    ...
    <b>$ </b>
    <br />
    Inventive cocktails and small plates in a warm, eco-friendly setting with
    regular tastings and classes.
  </Popover>
);
      ...
      <div id="datebackground">
        <div>
          ...
          <div class="btn-group-vertical">
            ...
            >
              <Button id="dateone" onClick={this.buttonOneClick}>
                FREMONT BREWERY
              </Button>
            </OverlayTrigger>
            ...
            >
              <Button id="datetwo" onClick={this.buttonTwoClick}>
            ...
            >
              <Button id="datethree" onClick={this.buttonThreeClick}>
                THE BACKDOOR
              </Button>
            </OverlayTrigger>
            ...
            <OverlayTrigger
              ...
              overlay={popoverHoverFocus}
            >
              <Button id="datefour" onClick={this.buttonFourClick}>
                THE BARREL THIEF
              </Button>
            </OverlayTrigger>
          </div>
        ...
        <div class="btn-group-vertical">
          ...
          {this.state.showComponent ? <ColorMap /> : null}

          <Button
            id={this.state.nextButton}
          ...
          {this.state.availability ? (
            <Availability2
              ...
              initialStart={this.state.dateAvailability}
              currAvailability={this.state.dateAvailability}
            />
          ) : null}
        </div>
      </div>
