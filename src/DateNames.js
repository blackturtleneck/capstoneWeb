...
const popoverHoverFocus3 = (
    <Popover id="bakdoor" title="The Backdoor">
        ...
        <b>$ </b>
        <br />
        Speakeasy-style lounge behind Roxy's Diner, for cocktails, small plates
...
const popoverHoverFocus4 = (
    <Popover id="barrel" title="The Barrel Thief">
        ...
        <b>$ </b>
        <br />
        Inventive cocktails and small plates in a warm, eco-friendly setting
        with regular tastings and classes.
    </Popover>
);
