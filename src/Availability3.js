      ...
      for (let j = 1; j <= days.length; j++) {
        ...
        if (this.state.cells[i]) {
          if (this.state.cells[i][j]) {
            ...
            if (dayExists) {
              let currEndTime =
                a[dayLocation].times[a[dayLocation].times.length - 1].end;
              if (currEndTime === timeVal) {
                a[dayLocation].times[
                  a[dayLocation].times.length - 1
                ].end = endTime;
              } else {
      ...
      <div>
        <div className="availabilityTableDragDown">
          ...
          >
            ...
            <tr className="availabilityRow">
              <td disabled className="timeLabel" style={{ textAlign: "right" }}>
                10:00AM
              </td>
              <td />
              <td />
            ...
            <tr className="availabilityRow">
              <td disabled className="timeLabel" />
              <td />
              <td />
              <td />
              <td />
          ...
          <Button onClick={this.userRespondedAvailablity}>
            {" "}
            Send Availability{" "}
          </Button>
        </div>
